(() => {
  ...
  const btntoCosmocentro = document.getElementById("toCosmocentro");
  const btntoPlazacayzedo = document.getElementById("toPlazacayzedo");
  ...
  const btntoAladdin18 = document.getElementById("toAladdin18");
  const btntoAladdin22 = document.getElementById("toAladdin22");
  ...
  if (btntoAladdin22) {
    btntoAladdin22.addEventListener("click", () => {
      window.open();
    });
  }
